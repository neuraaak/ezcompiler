# ///////////////////////////////////////////////////////////////
# TEMPLATE_LOADER - Template loading and resource access
# Project: ezcompiler
# ///////////////////////////////////////////////////////////////

"""
Template loader - Template loading and resource access for EzCompiler.

This module provides functionality for loading template files from the
assets directory. It serves as the resource access layer for templates,
delegating processing to TemplateProcessor in utils.
"""
...
class TemplateLoader:
    """
    Loader for template resource files.
    ...
    Example:
        ...
        >>> template = loader.load_template("config", "yaml")
        >>> content = loader.process_config_template("yaml", config_dict)
    """
