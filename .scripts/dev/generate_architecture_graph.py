...
"""
Generate architecture dependency graph for EzCompiler documentation.
...
LAYER_STYLES = {
    "interfaces": "fill:#4A90D9,color:#fff,stroke:#2C5F8A",
    "services": "fill:#5BA85A,color:#fff,stroke:#3A6B39",
    "adapters": "fill:#E8922A,color:#fff,stroke:#A3621B",
    "shared": "fill:#9B59B6,color:#fff,stroke:#6C3483",
    "utils": "fill:#E74C3C,color:#fff,stroke:#A93226",
    "assets": "fill:#7F8C8D,color:#fff,stroke:#566573",
}
